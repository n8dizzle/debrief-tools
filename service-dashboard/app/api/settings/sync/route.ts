...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Widened recall sync (ALL business units, enriched + equipment). is_service_bu
    // tagging preserves the HVAC-service-scoped leaderboard metric. Shared with cron sync.
