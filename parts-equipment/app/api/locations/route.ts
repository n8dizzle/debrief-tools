...
// GET /api/locations — full list (incl. inactive), ordered. Settings needs all
...
// POST /api/locations — add a physical location (appended to the end).
...
// PUT /api/locations — reorder. Body: { ids: number[] } in desired order.
