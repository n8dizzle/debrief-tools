...
async def process_webhook(payload: dict, db: Session) -> dict:
    ...
    try:
        ...
        ticket = TicketRaw(
            ...
            payment_method=enriched.get("payment_method"),
            ...
            membership_id=enriched.get("membership_id"),
            ...
            installed_equipment=enriched.get("installed_equipment"),
            installed_equipment_count=enriched.get("installed_equipment_count", 0),
            invoice_items=enriched.get("invoice_items"),
            invoice_materials_count=enriched.get("invoice_materials_count", 0),
            invoice_equipment_count=enriched.get("invoice_equipment_count", 0),
            invoice_services_count=enriched.get("invoice_services_count", 0),
