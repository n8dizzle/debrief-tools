...
import CelebrationsSidebar from './CelebrationsSidebar';
...
export default function DashboardShell({ children }: DashboardShellProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <AnalyticsTracker app="celebrations" />
      {/* Mobile Header */}
      <header
      ...
      <CelebrationsSidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
